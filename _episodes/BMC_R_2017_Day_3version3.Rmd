...
```{r}
reducedSmokeExercise = cbind(smokeExercise[,"Freq"], smokeExercise[,"None"] + smokeExercise[,"Some"]) 
...
Anova is a parameteric method appropriate for comparing the means of 2 or more independent populations. 
```{r}
attach(InsectSprays)
 data(InsectSprays)
 str(InsectSprays)
